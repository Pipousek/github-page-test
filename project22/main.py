...
def create_signature_download(signature):
    ...
    try:
        ...
        # Create a blob from the signature
        signature_blob = Uint8Array.new(signature)
        signature_file = File.new([signature_blob], "signature.bin", {"type": "application/octet-stream"})
        ...
        console.log("Signature download created")
    except Exception as e:
