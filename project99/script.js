...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelector("#qr_mode_visible").addEventListener("change", function() {
        const visibleSelect = document.querySelector("#qr_mode_visible");
        const hiddenSelect = document.querySelector("#qr_mode");
        
        // Sync the values
        hiddenSelect.value = visibleSelect.value;
        
        // Trigger the change event on the hidden select that PyScript is listening to
